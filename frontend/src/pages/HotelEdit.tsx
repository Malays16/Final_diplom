    ...
    <div className="page">
      <form className="form-hotel" onSubmit={handleSubmit}>
        ...
        <div className="hotel-images">
            ...
            <div className="form-input">
              <div className="hotel-images-list">
                {images.map((image, index) => (
                  <div className="hotel-image" key={index}>
          ...
          <div className="form-input">
            <label htmlFor="hotel-images-input" className="upload-label"></label>
            <input type="file" id="hotel-images-input" multiple onChange={handleImageUpload} />
          </div>
        </div>
        <div className="form-input">
